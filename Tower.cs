...
public class Tower : MonoBehaviour
{
    ...
    GameObject trainingGameObject;
    public int warriorPointCount = 0;
    Animator trainingAnimatorPageOn_A;
    Animator towerIOffAnimator;
    ...
    private void Start()
    {
        trainingGameObject = GameObject.Find("Training");
        training = trainingGameObject.GetComponent<Training>();
        trainingAnimatorPageOn_A = trainingGameObject.GetComponent<Animator>();
        towerIOffAnimator = trainingGameObject.GetComponent<Animator>();
    }
